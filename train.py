    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        for i, (imgs, targets, paths, _) in pbar:  # batch -------------------------------------------------------------
            ...
            with torch.cuda.amp.autocast(amp):
                ...
                if opt.quad:
                    loss *= 4.0
                # Compute distillation loss if a teacher model is loaded
...
# Define Distillation Loss (place this definition near the top of the script or before the training loop)
def compute_distillation_loss(student_preds, teacher_preds, temperature=1.0):
    """
